<?php include './components/header.php' ;?>
		...
		<main>
				...
				<div class="container">
					<div class="row align-items-center justify-content-lg-between">
						<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 wow fadeInLeft" data-wow-delay=".1s">
							<h1 class="page_title mb-0">Portfolio</h1>
						</div>
			...
			================================================== -->
			<section class="details_section portfolio_details sec_ptb_130 clearfix">
				<div class="container">

					<div class="masonry_details_images grid">
						<div class="grid-sizer"></div>
						<div class="grid-item w_66">
							<div class="details_image wow fadeInLeft" data-wow-delay=".1s">
								<img src="assets/images/details/portfolio/img_01.jpg" alt="image_not_found">
							</div>
						</div>

						<div class="grid-item">
							<div class="details_image wow fadeInRight" data-wow-delay=".2s">
								<img src="assets/images/details/portfolio/img_02.jpg" alt="image_not_found">
							</div>
						</div>

						<div class="grid-item">
							<div class="details_image wow fadeInLeft" data-wow-delay=".3s">
								<img src="assets/images/details/portfolio/img_03.jpg" alt="image_not_found">
							</div>
						</div>

						<div class="grid-item w_66">
							<div class="details_image wow fadeInRight" data-wow-delay=".4s">
								<img src="assets/images/details/portfolio/img_04.jpg" alt="image_not_found">
							</div>
						</div>
					</div>

					<div class="details_content p-0">
						<div class="portfolio_details_info mb_50">
							<div class="row wow fadeInUp2" data-wow-delay=".1s">
								<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
									<div class="info_wrap">
										<h4>Clients</h4>
										<p>Marcos Ribeiro Ferreira</p>
									</div>
								</div>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="info_wrap">
										<h4>Category</h4>
										<p>Business Cart Design & Branding</p>
									</div>
								</div>
								...
								<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
									<div class="info_wrap">
										<h4>City</h4>
										<p>25 Main Street, New York</p>
									</div>
								</div>

								<div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
									<ul class="square_social_links ul_li_right clearfix">
										<li>
						...
						<div class="wow fadeInUp2" data-wow-delay=".2s">
							<h2 class="item_title mb_30">Business Cart Design & Branding</h2>
							<p class="mb_30">
							...
							<p class="mb_30">
								But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness. No one rejects, dislikes, or avoids pleasure itself, because it is pleasure, but because those who do not know how to pursue pleasure rationally encounter consequences that are extremely painful. Nor again is there anyone who loves or pursues or desires to obtain pain of itself, because it is pain, but because occasionally circumstances occur in which toil and pain can procure him some great pleasure. To take a trivial example, which of us ever undertakes laborious physical exercise, except to obtain some advantage from it? But who has any right to find fault with a man who chooses to enjoy a pleasure that has no annoying consequences, or one who avoids a pain that produces no resultant pleasureSed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatu
							</p>
						</div>
						...
						<div class="row wow fadeInUp2" data-wow-delay=".1s">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="details_image mb_30">
									<img src="assets/images/details/portfolio/img_05.jpg" alt="image_not_found">
								</div>
							</div>

							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="details_image mb_30">
									<img src="assets/images/details/portfolio/img_06.jpg" alt="image_not_found">
								</div>
							</div>
						</div>
					...
					<div class="row justify-content-center">
						<div class="col-lg-7 col-md-8 col-sm-10 col-xs-12">
							<div class="section_title text-center mb_50 wow fadeInUp2" data-wow-delay=".1s">
								<h4 class="small_title">Our Related Project</h4>
								<h2 class="big_title mb-0">
									Experience Allows Us To Printing Things
								</h2>
								<span class="biggest_title">Project</span>
							</div>
						</div>
					</div>
					...
					<div class="row justify-content-center">
						<div class="col-lg-4 col-md-5 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".3s">
							<div class="feature_card">
								<a class="item_image plus_effect" target="_blank" href="portfolio_details.html">
