					...
					<div class="col-lg-4 col-md-8">
						<div class="widget footer_about bg_black">
							<div class="brand_logo bg_default_yellow">
								<a href="index.html">
									<img src="assets/images/logo/logo_03_1x.png" srcset="assets/images/logo/logo_03_2x.png 2x" alt="logo_not_found">
								</a>
							</div>
							<p class="mb_30">
							...
							<div class="copyright_text bg_black">
								<p class="mb-0">© Copyright 2021 All Right Reserved .<br> Developed By <a class="author_links" target="_blank" href="https://aminulahad.me">Aminul Ahad</a></p>
							</div>
						</div>
					</div>
								...
								<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
									<div class="widget footer_useful_links">
										...
										<ul class="ul_li_block clearfix">
											<li><a href="#!"></a></li>
											<li><a href="#!">Printing & Pakaging </a></li>
											<li><a href="#!">Offset Printing</a></li>
											<li><a href="#!">Corporate Printing</a></li>
											<li><a href="#!">Creative Design & Branding</a></li>
									...
									<div class="widget footer_contact_info clearfix">
										...
										<ul class="ul_li_block clearfix">
											...
											<li>
												...
												<div class="item_content">
													<h4>Locations</h4>
													<p> 9,Purana Paltan Line, Dhaka</p>
												</div>
											</li>
										</ul>
									</div>
									...
									<div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">
										<form action="#">
											<ul class="form_list ul_li_right clearfix">
												...
												<li><button type="submit" class="icon_btn"><i class="far fa-arrow-right"></i></button></li>
											</ul>
										</form>
									</div>
								</div>
